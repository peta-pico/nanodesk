						...
						<div class="module-block__content  no-space">
							...
							<label for="doi">DOI:</label>	
								...
								<div class="input-group">
									...
									<div id="doi_submit" class="input-group-addon" style="background-color:#337ab7 !important;">Check DOI now</div>
								</div>
								<button type="submit" id="doi_submit2" class="btn btn-md btn-primary input-group-addon bg-primary">Check DOI</button>
